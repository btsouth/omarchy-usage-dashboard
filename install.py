...
def main():
    ...
    for name in ['collector.py','catalog.json','pricing.json','muse-pricing.json','codex-pricing.json','ollama-pricing.json','commandcode-pricing.json','launch.sh','refresh.sh','LICENSE']:
