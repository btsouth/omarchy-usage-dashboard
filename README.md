...
Drop `--with-plugin` for the dashboard without the bar widget. Pin a release with `OMARCHY_USAGE_REF=v1.2.0` in front of the command. Installing from a checkout also works:
